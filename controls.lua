...
-- Tracking Figure Size -----------------------------------------------------

table.insert(ctrls, {
  Name = "tracking_figure_full",
  ControlType = "Button",
  ButtonType = "Momentary",
  Count = 1,
  UserPin = true,
...
table.insert(ctrls, {
  Name = "tracking_figure_half_body",
  ControlType = "Button",
  ButtonType = "Momentary",
  Count = 1,
  UserPin = true,
